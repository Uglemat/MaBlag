...
class TagBase(object):
    ...
    def __init__(self, name, enclosed=False, auto_close=False, inline=True, strip_first_newline=False, **kwargs):
...
class HtmlTag(TagBase):
    ...
    def __init__(self, name, **kwargs):
        super(HtmlTag, self).__init__(name, enclosed=True, strip_first_newline=True)
...
class RightTag(TagBase):
    ...
    def render_open(self, parser, node_index, **kwargs):
        return u'<div style="float:right;">'
